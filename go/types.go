// Package relativetimeformatter provides a Go client for the Relative Time Formatter API.
//
// For more information, visit: https://apiverve.com/marketplace/relativetimeformatter?utm_source=go&utm_medium=readme
package relativetimeformatter
...
// Request contains the parameters for the Relative Time Formatter API.
//
// Parameters:
//   - timestamp (required): string - Unix timestamp in seconds or milliseconds
//   - reference: string - Reference time to compare against (default: current time) [format: date]
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"reference": {Type: "string", Required: false, Format: "date"},
...
// ResponseData contains the data returned by the Relative Time Formatter API.
type ResponseData struct {
	...
	PrimaryValue int `json:"primary_value"`
	AllUnits AllUnitsData `json:"all_units"`
	Style string `json:"style"`
}

// AllUnitsData represents the all_units object.
type AllUnitsData struct {
