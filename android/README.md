# Relative Time Formatter Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:relativetimeformatter-api:1.1.14'
}
```
...
```java
import com.apiverve.relativetimeformatter.RelativeTimeFormatterAPIClient;
import com.apiverve.relativetimeformatter.APIResponse;
import com.apiverve.relativetimeformatter.APIException;

// Initialize the client
RelativeTimeFormatterAPIClient client = new RelativeTimeFormatterAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("timestamp", "1609459200");
    parameters.put("reference", "now");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/relativetimeformatter](https://docs.apiverve.com/ref/relativetimeformatter)
...
- **Documentation:** [https://docs.apiverve.com/ref/relativetimeformatter](https://docs.apiverve.com/ref/relativetimeformatter)
- **Issues:** [GitHub Issues](https://github.com/apiverve/relativetimeformatter-api/issues)
