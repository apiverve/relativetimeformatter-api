...
{
    class RelativeTimeFormatterExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/relativetimeformatter";

        /// <summary>
        /// Make a GET request to the Relative Time Formatter API
        /// </summary>
        static async Task<JsonDocument> CallRelativeTimeFormatterAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;timestamp&quot;] &#x3D; &quot;1609459200&quot;, [&quot;date&quot;] &#x3D; &quot;2024-01-01T00:00:00Z&quot;, [&quot;reference&quot;] &#x3D; &quot;2024-06-01T00:00:00Z&quot;, [&quot;style&quot;] &#x3D; &quot;short&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Relative Time Formatter API...\n");

            var result = await CallRelativeTimeFormatterAPI();
