...
namespace APIVerve.API.RelativeTimeFormatter
{
    ...
    /// <summary>
    /// Client for the RelativeTimeFormatter API
    /// </summary>
    public class RelativeTimeFormatterAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/relativetimeformatter";
        ...
        {
            { "timestamp", new ValidationRule { Type = "string", Required = true, Format = "timestamp" } },
            { "reference", new ValidationRule { Type = "string", Required = false, Format = "date" } },
        ...
        public RelativeTimeFormatterAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public RelativeTimeFormatterAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public RelativeTimeFormatterAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, RelativeTimeFormatterQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(RelativeTimeFormatterQueryOptions options)
        {
        ...
        public ResponseObj Execute(RelativeTimeFormatterQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(RelativeTimeFormatterQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(RelativeTimeFormatterQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(RelativeTimeFormatterQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(RelativeTimeFormatterQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(RelativeTimeFormatterQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(RelativeTimeFormatterQueryOptions options)
        {
