...
class TestRelativetimeformatterAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = RelativetimeformatterAPIClient(self.api_key)

    @patch('apiverve_relativetimeformatter.apiClient.requests.get')
